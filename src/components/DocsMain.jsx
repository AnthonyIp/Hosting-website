...
const DocsMain = () => {
    return (
        <section className="docs__main my-4">
            <div className="container grid">
                <div className="card bg-light p-3">
                    <h3 className="my-2">Essentials</h3>
                    <nav>
                        <ul>
                            <li><Link to="#" className="text-primary">Introduction</Link></li>
                            <li><Link to="#">About Hosting</Link></li>
                ...
                <div className="card">
                    ...
                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Minima totam magni eius vitae velit id, atque veritatis! At, vero
                        porro.</p>
